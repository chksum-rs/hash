...
//!
//! let digest = sha2::sha224::hash("some data");
//! assert_eq!(sha2::sha224::verify("some data", digest), true);
//! assert_eq!(sha2::sha224::verify("SOME DATA", digest), false);
//! ```
//!
//! # Stream processing
//!
...
//!
//! # fn wrapper() -> io::Result<()> {
//! let digest_lowercase = sha2::sha224::hash("some data");
//! let digest_uppercase = sha2::sha224::hash("SOME DATA");
//!
//! # let path = {
//! #     let mut file = NamedTempFile::new()?;
//! #     file.write(b"some data")?;
...
///
/// let digest = sha2::sha224::hash("data");
/// assert_eq!(sha2::sha224::verify("data", digest), true);
/// assert_eq!(sha2::sha224::verify("DATA", digest), false);
/// ```
#[cfg_attr(release, inline)]
#[must_use]
